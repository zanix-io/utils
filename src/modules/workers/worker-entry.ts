 ...
 * merging this back into a module the host imports for its exports (as it used to be, when this
 * lived in `processor.ts` itself) would install these same global handlers in the HOST process
 * too, silently swallowing every one of its own unhandled promise rejections process-wide.
 */
