  ...
  const testCasesWithIndex = [
    {
      ...
      startAfter: -1,
      endBefore: -2,
      expected: `${pref}0e494e5a5e454616`,
    },
    {
      input,
      startAfter: -10,
    ...
    },
    {
      ...
      startAfter: 1,
      endBefore: 1,
      expected: `8${separator}m${pref}1a1b0c5d4040t`,
    },
    { input, startAfter: 1, expected: `8${separator}m${pref}1a1b0c5d404047` },
    {
      ...
      startAfter: 1,
      endBefore: 2,
      expected: `8${separator}m${pref}1a1b0c5d40ut`,
    },
    {
      input: 'masks',
      startAfter: 0,
      endBefore: 0,
      expected: `${pref}0e51165843`,
    },
    {
      input: 'masks',
      startAfter: 0,
      endBefore: 1,
      expected: `5${separator}${pref}0e511658s`,
    },
    {
      input: 'masks',
      startAfter: 0,
      endBefore: 2,
      expected: `5${separator}${pref}0e5116ks`,
    },
    {
      input: 'masks',
      startAfter: 0,
      endBefore: 3,
      expected: `5${separator}${pref}0e51sks`,
    },
    {
      input: 'masks',
      startAfter: 0,
      endBefore: 4,
      expected: `5${separator}${pref}0easks`,
    },
    {
      input: 'masks',
      startAfter: 0,
    ...
    },
    {
      ...
      startAfter: 1,
      endBefore: 0,
      expected: `5${separator}m${pref}02430e40`,
    },
    {
      input: 'masks',
      startAfter: 1,
      endBefore: 1,
      expected: `5${separator}m${pref}02430es`,
    },
    {
      input: 'masks',
      startAfter: 1,
      endBefore: 2,
      expected: `5${separator}m${pref}0243ks`,
    },
    {
      input: 'masks',
      startAfter: 1,
      endBefore: 3,
      expected: `5${separator}m${pref}02sks`,
    },
    {
      input: 'masks',
      startAfter: 1,
    ...
    },
    {
      ...
      startAfter: 2,
      endBefore: 0,
      expected: `5${separator}ma${pref}105b16`,
    },
    {
      input: 'masks',
      startAfter: 2,
      endBefore: 1,
      expected: `5${separator}ma${pref}105bs`,
    },
    {
      input: 'masks',
      startAfter: 2,
      endBefore: 2,
      expected: `5${separator}ma${pref}10ks`,
    },
    {
      input: 'masks',
      startAfter: 2,
    ...
    },
    {
      ...
      startAfter: 3,
      endBefore: 0,
      expected: `5${separator}mas${pref}0843`,
    },
    {
      input: 'masks',
      startAfter: 3,
      endBefore: 1,
      expected: `5${separator}mas${pref}08s`,
    },
    {
      input: 'masks',
      startAfter: 3,
    ...
    },
    {
      ...
      startAfter: 4,
      endBefore: 0,
      expected: `5${separator}mask${pref}10`,
    },
    {
      input: 'masks',
      startAfter: 4,
...
Deno.test('Masking and unmasking should works with chars test cases', () => {
  ...
  const testCasesChar = [
    ...
    },
    {
      startAfter: 5,
      endBefore: '@',
      expected: `21${separator}pepit${pref}19110907000c@gmail.com`,
    },
    {
      startAfter: 7,
      endBefore: '@',
      expected: `21${separator}pepitop${pref}1313090f@gmail.com`,
    },
    {
      startAfter: 8,
      endBefore: '@',
      expected: `21${separator}pepitope${pref}040416@gmail.com`,
    },
    {
      startAfter: 9,
      endBefore: '@',
      expected: `21${separator}pepitoper${pref}131b@gmail.com`,
    },
    {
      startAfter: 12,
      endBefore: '@',
    ...
    },
    {
      startAfter: 13,
      endBefore: 'l',
      expected: `21${separator}pepitoperez@g${pref}1b0005l.com`,
    },
    {
      startAfter: 20,
      endBefore: 'l',
    ...
    },
    {
      startAfter: 18,
      endBefore: '*',
      expected: `21${separator}pepitoperez@gmail.${pref}150e01`,
    },
    {
      startAfter: 19,
      endBefore: '*',
      expected: `21${separator}pepitoperez@gmail.c${pref}190c`,
    },
    {
      startAfter: 23,
      expected: `${pref}06041c1c1119110907000c210b18041f0d42160a1b`,
    },
  ]

  testCasesChar.forEach(({ startAfter, endBefore, expected }) => {
    assertEquals(
      mask('pepitoperez@gmail.com', secret, { startAfter, endBefore }),
      expected,
    )
    assertEquals(
      unmask(expected, secret, { startAfter, endBefore }),
